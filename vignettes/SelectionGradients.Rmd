...
The benefit of using psa::glam over stats::lm or stats::glm is that glam has built-in options to make the regression coefficients more directly comparable to selection gradients. There are three main benefits to using glam:
